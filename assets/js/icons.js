/* ============================================================
   VERITAS — Stroke icon system (Lucide-style, 1.75 weight)
   Usage in HTML:  <i data-icon="search"></i>
   Programmatic:   window.icon('search', {size:16})
   ============================================================ */
(function () {
  const P = {
    /* nav */
    ...
    network: '<circle cx="12" cy="5" r="2.5"/><circle cx="5" cy="19" r="2.5"/><circle cx="19" cy="19" r="2.5"/><path d="M12 7.5v3"/><path d="M11 11.6 6.5 16.8"/><path d="M13 11.6 17.5 16.8"/>',
    ...
    warn: '<path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/><line x1="12" y1="9" x2="12" y2="13.5"/><line x1="12" y1="17" x2="12.01" y2="17"/>',
    ...
    wallet: '<path d="M19 7V5a2 2 0 0 0-2-2H5a2 2 0 0 0 0 4h15a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1h-2a2 2 0 0 1 0-4h2"/><path d="M3 5v14a2 2 0 0 0 2 2h14a1 1 0 0 0 1-1v-3"/>',
    ...
    scan: '<path d="M3 7V5a2 2 0 0 1 2-2h2"/><path d="M17 3h2a2 2 0 0 1 2 2v2"/><path d="M21 17v2a2 2 0 0 1-2 2h-2"/><path d="M7 21H5a2 2 0 0 1-2-2v-2"/><circle cx="11" cy="11" r="3"/><path d="m16 16-1.8-1.8"/>',
    ...
    chevrightdouble: '<path d="m6 17 5-5-5-5"/><path d="m13 17 5-5-5-5"/>',
    waypoint: '<path d="M12 13a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"/><path d="M12 22c5-3.5 8-6.5 8-12a8 8 0 1 0-16 0c0 5.5 3 8.5 8 12Z"/>',
  ...
  function svg(name, opts) {
    ...
    return `<svg${size}${cls} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${sw}" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${inner}</svg>`;
  }
  ...
  function hydrate(root) {
    (root || document).querySelectorAll('[data-icon]').forEach(function (el) {
      ...
      const sw = el.getAttribute('data-stroke');
      el.innerHTML = svg(name, { size: size ? +size : null, stroke: sw ? +sw : null });
